...
[data-bs-theme=light] {
  ...
  --bs-success-rgb: 222, 226, 230;
  --bs-info-rgb: 206, 212, 218;
  --bs-warning-rgb: 173, 181, 189;
  --bs-danger-rgb: 108, 117, 125;
  --bs-light-rgb: 233, 236, 239;
  --bs-dark-rgb: 33, 37, 41;
  --bs-primary-text-emphasis: black;
  --bs-secondary-text-emphasis: #666666;
  --bs-success-text-emphasis: rgb(88.8, 90.4, 92);
  --bs-info-text-emphasis: rgb(82.4, 84.8, 87.2);
  --bs-warning-text-emphasis: rgb(69.2, 72.4, 75.6);
  --bs-danger-text-emphasis: rgb(43.2, 46.8, 50);
  --bs-light-text-emphasis: #495057;
  --bs-dark-text-emphasis: #495057;
  --bs-primary-bg-subtle: #cccccc;
  --bs-secondary-bg-subtle: white;
  --bs-success-bg-subtle: rgb(248.4, 249.2, 250);
  --bs-info-bg-subtle: rgb(245.2, 246.4, 247.6);
  --bs-warning-bg-subtle: rgb(238.6, 240.2, 241.8);
  --bs-danger-bg-subtle: rgb(225.6, 227.4, 229);
  --bs-light-bg-subtle: rgb(251.5, 252, 252.5);
  --bs-dark-bg-subtle: #ced4da;
  --bs-primary-border-subtle: #999999;
  --bs-secondary-border-subtle: white;
  --bs-success-border-subtle: rgb(241.8, 243.4, 245);
  --bs-info-border-subtle: rgb(235.4, 237.8, 240.2);
  --bs-warning-border-subtle: rgb(222.2, 225.4, 228.6);
  --bs-danger-border-subtle: rgb(196.2, 199.8, 203);
...
[data-bs-theme=dark] {
  ...
  --bs-success-text-emphasis: rgb(235.2, 237.6, 240);
  --bs-info-text-emphasis: rgb(225.6, 229.2, 232.8);
  --bs-warning-text-emphasis: rgb(205.8, 210.6, 215.4);
  --bs-danger-text-emphasis: rgb(166.8, 172.2, 177);
  --bs-light-text-emphasis: #f8f9fa;
  --bs-dark-text-emphasis: #dee2e6;
  --bs-primary-bg-subtle: black;
  --bs-secondary-bg-subtle: #333333;
  --bs-success-bg-subtle: rgb(44.4, 45.2, 46);
  --bs-info-bg-subtle: rgb(41.2, 42.4, 43.6);
  --bs-warning-bg-subtle: rgb(34.6, 36.2, 37.8);
  --bs-danger-bg-subtle: rgb(21.6, 23.4, 25);
  --bs-light-bg-subtle: #343a40;
  --bs-dark-bg-subtle: #1a1d20;
  --bs-primary-border-subtle: black;
  --bs-secondary-border-subtle: #999999;
  --bs-success-border-subtle: rgb(133.2, 135.6, 138);
  --bs-info-border-subtle: rgb(123.6, 127.2, 130.8);
  --bs-warning-border-subtle: rgb(103.8, 108.6, 113.4);
  --bs-danger-border-subtle: rgb(64.8, 70.2, 75);
...
.table-info {
  --bs-table-color: #000;
  --bs-table-bg: rgb(245.2, 246.4, 247.6);
  --bs-table-border-color: rgb(196.16, 197.12, 198.08);
  --bs-table-striped-bg: rgb(232.94, 234.08, 235.22);
  --bs-table-striped-color: #000;
  --bs-table-active-bg: rgb(220.68, 221.76, 222.84);
  --bs-table-active-color: #000;
  --bs-table-hover-bg: rgb(226.81, 227.92, 229.03);
  --bs-table-hover-color: #000;
  color: var(--bs-table-color);
  border-color: var(--bs-table-border-color);
}
...
.was-validated .form-control:valid, .form-control.is-valid {
  ...
  background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23dee2e6' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
  background-repeat: no-repeat;
...
.was-validated .form-select:valid:not([multiple]):not([size]), .was-validated .form-select:valid:not([multiple])[size="1"], .form-select.is-valid:not([multiple]):not([size]), .form-select.is-valid:not([multiple])[size="1"] {
  --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%23dee2e6' d='M2.3 6.73.6 4.53c-.4-1.04.46-1.4 1.1-.8l1.1 1.4 3.4-3.8c.6-.63 1.6-.27 1.2.7l-4 4.6c-.43.5-.8.4-1.1.1z'/%3e%3c/svg%3e");
...
.was-validated .form-select:invalid:not([multiple]):not([size]), .was-validated .form-select:invalid:not([multiple])[size="1"], .form-select.is-invalid:not([multiple]):not([size]), .form-select.is-invalid:not([multiple])[size="1"] {
  --bs-form-select-bg-icon: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%236c757d'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath stroke-linejoin='round' d='M5.8 3.6h.4L6 6.5z'/%3e%3ccircle cx='6' cy='8.2' r='.6' fill='%236c757d' stroke='none'/%3e%3c/svg%3e");
  padding-right: 4.125rem;
  background-position: right 0.75rem center, center right 2.25rem;
  background-size: 16px 12px, calc(0.75em + 0.375rem) calc(0.75em + 0.375rem);
}
